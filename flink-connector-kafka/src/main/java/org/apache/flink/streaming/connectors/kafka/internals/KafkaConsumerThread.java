...
public class KafkaConsumerThread<T> extends Thread {
    ...
    public void run() {
        ...
        try {
            ...
            handleMainFetchLoopError(handover, t);
        } finally {
    ...
    private void registerKafkaMetrics() {
    ...
    private void handleMainFetchLoopError(Handover handover, Throwable t) {
